...
# 设置中文字体
#苹果电脑中文字体会不一致，font_path = 替换试下运行
# font_path = '/System/Library/Fonts/Heiti TC.ttc'  或   font_path = '/Library/Fonts/Heiti TC.ttc'  
# font_path = '/System/Library/Fonts/Songti SC.ttc' 或  font_path = '/Library/Fonts/Songti SC.ttc'
# 还是不行，2个合并写：my_font = fm.FontProperties(family='Heiti TC')
...
plt.legend(prop=my_font)  # 设置图例字体：此段警告提示_没有图例，可忽略；不想看到这个提示，就把这段加 #注释本句
plt.show()
